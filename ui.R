...
shinyUI(fluidPage(
  ...
  # Application title
  titlePanel("Single word prediction"),
  ...
  sidebarPanel(
    ...
    helpText("Entered text phrase:"), tags$i("I have visited spain last"),
    helpText("Cleaned text phrase:"), tags$i("visited spain last"),
    helpText("Predicted next word - News articles:"), tags$i("season"),
    helpText("Predicted next word - Twitter data:"), tags$i("day")
  ),
